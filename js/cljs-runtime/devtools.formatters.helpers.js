...
var G__60178 = devtools.prefs.pref(v);
v = G__60178;
continue;
} else {
return v;
...
}catch (e60144){var _e__59417__auto__ = e60144;
return false;
}})();
...
}catch (e60146){var _e__59417__auto__ = e60146;
return false;
}})();
...
}catch (e60151){var _e__59417__auto__ = e60151;
return false;
}}
}
});
...
var vec__60157 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60157,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60157,(1),null);
...
return cljs.core.some((function (p1__60160_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__60160_SHARP_);
}),template);
});
