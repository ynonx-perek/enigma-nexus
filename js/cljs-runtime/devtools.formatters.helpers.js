...
var G__60071 = devtools.prefs.pref(v);
v = G__60071;
continue;
} else {
return v;
...
}catch (e59996){var _e__58941__auto__ = e59996;
return false;
}})();
...
}catch (e60009){var _e__58941__auto__ = e60009;
return false;
}})();
...
}catch (e60012){var _e__58941__auto__ = e60012;
return false;
}}
}
});
...
var vec__60030 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60030,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60030,(1),null);
...
return cljs.core.some((function (p1__60038_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__60038_SHARP_);
}),template);
});
