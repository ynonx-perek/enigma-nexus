...
var with_let61151 = reagent.ratom.with_let_values(new cljs.core.Keyword(null,"with-let61151","with-let61151",-160669261));
var temp__5808__auto___61172 = reagent.ratom._STAR_ratom_context_STAR_;
if((temp__5808__auto___61172 == null)){
} else {
var c__59154__auto___61173 = temp__5808__auto___61172;
if((with_let61151.generation === c__59154__auto___61173.ratomGeneration)){
...
(with_let61151.generation = c__59154__auto___61173.ratomGeneration);
}

var init61152 = (with_let61151.length === (0));
var expanded_STAR_ = ((((init61152) || (cljs.core.not(with_let61151.hasOwnProperty((0))))))?(with_let61151[(0)] = reagent.core.atom.cljs$core$IFn$_invoke$arity$1(false)):(with_let61151[(0)]));
var res61154 = (function (){var map__61162 = props;
var map__61162__$1 = cljs.core.__destructure_map(map__61162);
var tree_options = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61162__$1,new cljs.core.Keyword(null,"tree-options","tree-options",-1628159444));
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61162__$1,new cljs.core.Keyword(null,"value","value",305978217));
var nodes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61162__$1,new cljs.core.Keyword(null,"nodes","nodes",-2099585805));
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61162__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61162__$1,new cljs.core.Keyword(null,"style","style",-496642736));
var expanded_style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61162__$1,new cljs.core.Keyword(null,"expanded-style","expanded-style",1358008989));
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61162__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
var expanded_class = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61162__$1,new cljs.core.Keyword(null,"expanded-class","expanded-class",1084067344));
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),class$], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"style","style",-496642736),style], null),(function (){var G__61163 = type;
