...
var len__5766__auto___60615 = arguments.length;
var i__5767__auto___60616 = (0);
while(true){
if((i__5767__auto___60616 < len__5766__auto___60615)){
args__5772__auto__.push((arguments[i__5767__auto___60616]));

var G__60617 = (i__5767__auto___60616 + (1));
i__5767__auto___60616 = G__60617;
continue;
} else {
}
break;
...
var map__60604 = props;
var map__60604__$1 = cljs.core.__destructure_map(map__60604);
var multi_tab_table_STAR_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60604__$1,new cljs.core.Keyword(null,"multi-tab-table*","multi-tab-table*",1165715832));
var active_tab_index_STAR_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60604__$1,new cljs.core.Keyword(null,"active-tab-index*","active-tab-index*",-1568632993));
var column_index = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60604__$1,new cljs.core.Keyword(null,"column-index","column-index",470522340));
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60604__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
...
/** @this {Function} */
(enigma_nexus.tabs.tabs.tab_header_cell.cljs$lang$applyTo = (function (seq60602){
var G__60603 = cljs.core.first(seq60602);
var seq60602__$1 = cljs.core.next(seq60602);
var self__5751__auto__ = this;
return self__5751__auto__.cljs$core$IFn$_invoke$arity$variadic(G__60603,seq60602__$1);
}));

enigma_nexus.tabs.tabs.tab_headers = (function enigma_nexus$tabs$tabs$tab_headers(props){
var map__60605 = props;
var map__60605__$1 = cljs.core.__destructure_map(map__60605);
var multi_tab_table_STAR_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60605__$1,new cljs.core.Keyword(null,"multi-tab-table*","multi-tab-table*",1165715832));
var active_tab_index_STAR_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60605__$1,new cljs.core.Keyword(null,"active-tab-index*","active-tab-index*",-1568632993));
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60605__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
...
var with_let60608 = reagent.ratom.with_let_values(new cljs.core.Keyword(null,"with-let60608","with-let60608",1210940948));
var temp__5808__auto___60620 = reagent.ratom._STAR_ratom_context_STAR_;
if((temp__5808__auto___60620 == null)){
} else {
var c__59044__auto___60622 = temp__5808__auto___60620;
if((with_let60608.generation === c__59044__auto___60622.ratomGeneration)){
...
(with_let60608.generation = c__59044__auto___60622.ratomGeneration);
}

var init60609 = (with_let60608.length === (0));
var active_tab_index_STAR_ = ((((init60609) || (cljs.core.not(with_let60608.hasOwnProperty((0))))))?(with_let60608[(0)] = reagent.core.atom.cljs$core$IFn$_invoke$arity$1((0))):(with_let60608[(0)]));
var res60610 = (function (){var map__60613 = props;
var map__60613__$1 = cljs.core.__destructure_map(map__60613);
var multi_tab_table_STAR_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60613__$1,new cljs.core.Keyword(null,"multi-tab-table*","multi-tab-table*",1165715832));
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60613__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
var style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60613__$1,new cljs.core.Keyword(null,"style","style",-496642736));
