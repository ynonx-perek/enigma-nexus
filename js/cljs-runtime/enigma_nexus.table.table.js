...
var len__5766__auto___68227 = arguments.length;
var i__5767__auto___68228 = (0);
while(true){
if((i__5767__auto___68228 < len__5766__auto___68227)){
args__5772__auto__.push((arguments[i__5767__auto___68228]));

var G__68229 = (i__5767__auto___68228 + (1));
i__5767__auto___68228 = G__68229;
continue;
} else {
}
break;
...
var map__68220 = props;
var map__68220__$1 = cljs.core.__destructure_map(map__68220);
var table_data_STAR_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68220__$1,new cljs.core.Keyword(null,"table-data*","table-data*",1671610004));
var row_index = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68220__$1,new cljs.core.Keyword(null,"row-index","row-index",-828710296));
var column_index = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68220__$1,new cljs.core.Keyword(null,"column-index","column-index",470522340));
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68220__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
var with_let68221 = reagent.ratom.with_let_values(new cljs.core.Keyword(null,"with-let68221","with-let68221",-750412356));
var temp__5808__auto___68230 = reagent.ratom._STAR_ratom_context_STAR_;
if((temp__5808__auto___68230 == null)){
} else {
var c__59044__auto___68231 = temp__5808__auto___68230;
if((with_let68221.generation === c__59044__auto___68231.ratomGeneration)){
...
(with_let68221.generation = c__59044__auto___68231.ratomGeneration);
}

var init68222 = (with_let68221.length === (0));
var indicators_STAR_ = ((((init68222) || (cljs.core.not(with_let68221.hasOwnProperty((0))))))?(with_let68221[(0)] = reagent.core.cursor(table_data_STAR_,new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"rows","rows",850049680),row_index,new cljs.core.Keyword(null,"columns","columns",1998437288),column_index,new cljs.core.Keyword(null,"indicators","indicators",1312373003)], null))):(with_let68221[(0)]));
var res68223 = new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"class","class",-2030961996),class$,new cljs.core.Keyword(null,"on-click","on-click",1632826543),(function (){
...
/** @this {Function} */
(enigma_nexus.table.table.cell.cljs$lang$applyTo = (function (seq68214){
var G__68215 = cljs.core.first(seq68214);
var seq68214__$1 = cljs.core.next(seq68214);
var self__5751__auto__ = this;
return self__5751__auto__.cljs$core$IFn$_invoke$arity$variadic(G__68215,seq68214__$1);
}));

enigma_nexus.table.table.table = (function enigma_nexus$table$table$table(props){
var map__68224 = props;
var map__68224__$1 = cljs.core.__destructure_map(map__68224);
var table_data_STAR_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68224__$1,new cljs.core.Keyword(null,"table-data*","table-data*",1671610004));
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68224__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
